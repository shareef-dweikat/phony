...
import { getAzy, ChargeAzy } from "../../../actions/companiesAction";
import Spinner from "../../ui/spinner/Spinner";

const Azy = ({ getAzy, loading, azy, ChargeAzy }) => {
            ...
            <div className="card ooredoo-back">
              <div className="row">
                <div className=" col-5 m-3 mt-4">
                  <h1 className="jawwal-text m-4">{translate("mobile12")}</h1>
                </div>
                <div className=" col-2"></div>
                <div className=" col-4 d-flex align-items-left">
                  <img
...
export default connect(mapStateToProps, { getAzy, ChargeAzy })(Azy);
