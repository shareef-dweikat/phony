          ...
          <div className="">
              ...
              <div className="col-9">
                <div className=" card nav-layout">
                  <div className="form-group row">
                    ...
                    <label className="col-sm-6 col-form-label mobile-semi mt-2" style={{ fontSize: "1.2rem" }}>
                      {translate("jawwalOfferCredit")}
                    </label>
                    <label
                      className="col-sm-4 col-form-label mobile-semi"
            ...
            <div className=" card position-relative">
              ...
              <form class="form-inline mt-2">
                <div className="row">
                  <div className="my-3">
                    <div class="form-group row d-flex justify-content-center"></div>
                  </div>
                </div>
                <div class="form-group row d-flex justify-content-between">
                  ...
                  <button
                    type="submit"
                    class={`col-sm-2 btn btn sign-but mx-2 ${
                      (selected.price ? parseFloat(selected.price) : 0) +
                        (jawwalRom.price ? parseFloat(jawwalRom.price) : 0) +
                        (jawwal3g.price ? parseFloat(jawwal3g.price) : 0) +
                        (jawwalMin.price ? parseFloat(jawwalMin.price) : 0) ===
