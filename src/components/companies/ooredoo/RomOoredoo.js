        ...
        <div className="col-lg-9 col-md-8 col-sm-6">
            ...
            <div className="card ooredoo-back">
              <div className="row">
                <div className=" col-5 m-3">
                  <h1 className="jawwal-text m-4">{translate("Roaming")}</h1>
                </div>
          ...
          <div className="mt-2">
            ...
            <div className="row">
              ...
              {ooredooRom && ooredooRom.length === 0 && !loading ? (
                ...
                ooredooRom.map((item) => (
                  <div className="col-lg-3 col-md-4 col-sm-4 mt-3">
                    ...
                    <div className="card">
                      ...
                      >
                        <div className="card-body">{item.bundle_description}</div>
                      </div>
                    </div>
                  </div>
                ))
