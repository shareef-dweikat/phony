...
import { getOoredoo3g, getOoredoo3gRenew, getOoredoo3gNotRenew } from "../../../actions/companiesAction";
import Selected from "./Selected";
import Spinner from "../../ui/spinner/Spinner";

const Ooredoo3g = ({ getOoredoo3g, loading, ooredoo3g, getOoredoo3gNotRenew, getOoredoo3gRenew }) => {
  ...
  useEffect(() => {
    document.title = "Ooredoo  3G | Phone Play";
    getOoredoo3g();
            ...
            <div className="card ooredoo-back">
              <div className="row">
                <div className=" col-5 m-3 mt-4">
                  <h1 className="jawwal-text m-4">{translate("ooredoo3g")}</h1>
                </div>
...
const mapStateToProps = (state) => ({
  auth: state.auth,
  ooredoo3g: state.companies.ooredoo3g,
  loading: state.companies.loading,
});
export default connect(mapStateToProps, { getOoredoo3g, getOoredoo3gRenew, getOoredoo3gNotRenew })(Ooredoo3g);
